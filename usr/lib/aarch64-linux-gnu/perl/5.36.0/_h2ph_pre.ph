...
unless (defined &__AARCH64EL__) { sub __AARCH64EL__() { 1 } }

unless (defined &__AARCH64_CMODEL_SMALL__) { sub __AARCH64_CMODEL_SMALL__() { 1 } }

unless (defined &__ARM_64BIT_STATE) { sub __ARM_64BIT_STATE() { 1 } }

unless (defined &__ARM_ALIGN_MAX_PWR) { sub __ARM_ALIGN_MAX_PWR() { 28 } }

unless (defined &__ARM_ALIGN_MAX_STACK_PWR) { sub __ARM_ALIGN_MAX_STACK_PWR() { 16 } }

unless (defined &__ARM_ARCH) { sub __ARM_ARCH() { 8 } }

unless (defined &__ARM_ARCH_8A) { sub __ARM_ARCH_8A() { 1 } }

unless (defined &__ARM_ARCH_ISA_A64) { sub __ARM_ARCH_ISA_A64() { 1 } }

unless (defined &__ARM_ARCH_PROFILE) { sub __ARM_ARCH_PROFILE() { 65 } }

unless (defined &__ARM_FEATURE_CLZ) { sub __ARM_FEATURE_CLZ() { 1 } }

unless (defined &__ARM_FEATURE_FMA) { sub __ARM_FEATURE_FMA() { 1 } }

unless (defined &__ARM_FEATURE_IDIV) { sub __ARM_FEATURE_IDIV() { 1 } }

unless (defined &__ARM_FEATURE_NUMERIC_MAXMIN) { sub __ARM_FEATURE_NUMERIC_MAXMIN() { 1 } }

unless (defined &__ARM_FEATURE_UNALIGNED) { sub __ARM_FEATURE_UNALIGNED() { 1 } }

unless (defined &__ARM_FP) { sub __ARM_FP() { 14 } }

unless (defined &__ARM_FP16_ARGS) { sub __ARM_FP16_ARGS() { 1 } }

unless (defined &__ARM_FP16_FORMAT_IEEE) { sub __ARM_FP16_FORMAT_IEEE() { 1 } }

unless (defined &__ARM_NEON) { sub __ARM_NEON() { 1 } }

unless (defined &__ARM_PCS_AAPCS64) { sub __ARM_PCS_AAPCS64() { 1 } }
...
unless (defined &__DECIMAL_DIG__) { sub __DECIMAL_DIG__() { 36 } }
...
unless (defined &__FLT64X_DECIMAL_DIG__) { sub __FLT64X_DECIMAL_DIG__() { 36 } }

unless (defined &__FLT64X_DENORM_MIN__) { sub __FLT64X_DENORM_MIN__() { "6\.47517511943802511092443895822764655e\-4966F64x" } }

unless (defined &__FLT64X_DIG__) { sub __FLT64X_DIG__() { 33 } }

unless (defined &__FLT64X_EPSILON__) { sub __FLT64X_EPSILON__() { "1\.92592994438723585305597794258492732e\-34F64x" } }
...
unless (defined &__FLT64X_MANT_DIG__) { sub __FLT64X_MANT_DIG__() { 113 } }
...
unless (defined &__FLT64X_MAX__) { sub __FLT64X_MAX__() { "1\.18973149535723176508575932662800702e\+4932F64x" } }
...
unless (defined &__FLT64X_NORM_MAX__) { sub __FLT64X_NORM_MAX__() { "1\.18973149535723176508575932662800702e\+4932F64x" } }
...
unless (defined &__FLT_EVAL_METHOD_C99__) { sub __FLT_EVAL_METHOD_C99__() { 0 } }
...
unless (defined &__FP_FAST_FMA) { sub __FP_FAST_FMA() { 1 } }

unless (defined &__FP_FAST_FMAF) { sub __FP_FAST_FMAF() { 1 } }

unless (defined &__FP_FAST_FMAF32) { sub __FP_FAST_FMAF32() { 1 } }

unless (defined &__FP_FAST_FMAF32x) { sub __FP_FAST_FMAF32x() { 1 } }

unless (defined &__FP_FAST_FMAF64) { sub __FP_FAST_FMAF64() { 1 } }
...
unless (defined &__GCC_DESTRUCTIVE_SIZE) { sub __GCC_DESTRUCTIVE_SIZE() { 256 } }
...
unless (defined &__GCC_HAVE_SYNC_COMPARE_AND_SWAP_16) { sub __GCC_HAVE_SYNC_COMPARE_AND_SWAP_16() { 1 } }
...
unless (defined &__LDBL_DECIMAL_DIG__) { sub __LDBL_DECIMAL_DIG__() { 36 } }

unless (defined &__LDBL_DENORM_MIN__) { sub __LDBL_DENORM_MIN__() { 6.47517511943802511092443895822764655e-4966 } }

unless (defined &__LDBL_DIG__) { sub __LDBL_DIG__() { 33 } }

unless (defined &__LDBL_EPSILON__) { sub __LDBL_EPSILON__() { 1.92592994438723585305597794258492732e-34 } }
...
unless (defined &__LDBL_MANT_DIG__) { sub __LDBL_MANT_DIG__() { 113 } }
...
unless (defined &__LDBL_MAX__) { sub __LDBL_MAX__() { 1.18973149535723176508575932662800702e+4932 } }
...
unless (defined &__LDBL_NORM_MAX__) { sub __LDBL_NORM_MAX__() { 1.18973149535723176508575932662800702e+4932 } }
...
unless (defined &__aarch64__) { sub __aarch64__() { 1 } }
